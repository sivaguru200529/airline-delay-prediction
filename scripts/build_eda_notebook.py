"""Builds a structured, complete Jupyter Notebook for 04_eda.ipynb."""
...
def create_eda_notebook():
    """Construct nbformat 4 JSON structure for notebooks/04_eda.ipynb."""
    nb = {
        "cells": [
            {
                "cell_type": "markdown",
    ...
    nb_path = Path("notebooks/04_eda.ipynb")
    nb_path.write_text(json.dumps(nb, indent=1), encoding="utf-8")
    print(f"Generated complete EDA notebook at {nb_path.resolve()}")
